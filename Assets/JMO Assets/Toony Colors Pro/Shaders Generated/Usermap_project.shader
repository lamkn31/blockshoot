...
Shader "Toony Colors Pro 2/User/map_project"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		_RampSmoothing1 ("Smoothing", Range(0.001,1)) = 0.5
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float4 __albedo = ( TCP2_TEX2D_SAMPLE_TRIPLANAR(_BaseMap, _BaseMap, float4(1, 1, 1, 1) * _BaseMap_ST, positionWS, normalWS).rgba );
